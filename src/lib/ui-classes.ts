// Shared app UI class tokens, built on the semantic utilities from index.css.
...
export const menuRowClass = 'flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-left text-ui-md text-ink-soft transition-colors duration-150 ease-out hover:bg-surface-muted hover:text-ink focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-softer'
export const inputClass = 'min-w-0 rounded-lg border border-line-strong bg-surface px-2.5 py-2 text-ui-md text-ink outline-none transition placeholder:text-muted focus:border-accent focus-visible:ring-2 focus-visible:ring-accent-softer'
